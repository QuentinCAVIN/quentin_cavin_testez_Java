...
public class FareCalculatorServiceTest {
    ...
    // Attention les test avec les lambdas passent une fois sur deux @Disabled si ça recommence
    @Test 
    ...
    public void calculateFareCarWithDiscount(){
        ...
        ticket.setOutTime(outTime);
        ticket.setParkingSpot(parkingSpot);
        // à l'origine je voulais mettre un ticket.setDiscount(true) (sur le ticket)
        fareCalculatorService.calculateFare(ticket,true);
        assertEquals(Math.round(0.95*0.75* Fare.CAR_RATE_PER_HOUR*100.0)/100.0 , Math.round(ticket.getPrice() * 100.0)/100.0);
    ...
    public void calculateFareBikeWithDiscount(){
        ...
        ticket.setInTime(inTime);
        ticket.setOutTime(outTime);
        ticket.setParkingSpot(parkingSpot); // à l'origine je voulais mettre un ticket.setDiscount(true)
        fareCalculatorService.calculateFare(ticket,true);
        assertEquals((Fare.BIKE_RATE_PER_HOUR - (Fare.BIKE_RATE_PER_HOUR * 0.05)), Math.round(ticket.getPrice()*1000)/1000.0);
